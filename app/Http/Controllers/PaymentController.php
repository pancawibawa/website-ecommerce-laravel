...
class PaymentController extends Controller
{
	...
	// 	$validSignatureKey = hash("sha512", $notification->order_id . $notification->status_code . $notification->gross_amount . 'SB-Mid-server-8_qy9He8WbF2_WiynXeRYxiw');
	...
	public function notification(Request $request){
		...
		\Log::info('Notification received', (array) $notification); // Log the notification for debugging
	...
	public function completed(Request $request)
	{
		...
		\Log::info('Completed payment check for order: ', ['order_id' => $order->id, 'payment_status' => $order->payment_status]);
